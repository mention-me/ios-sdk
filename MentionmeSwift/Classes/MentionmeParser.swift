...
class MentionmeParser: NSObject{
    ...
    // Offer data parser
    static func getOffer(data: Data, success: @escaping (_ offer: MentionmeOffer?, _ sharelinks: [MentionmeShareLink]?, _ termsLinks: MentionmeTermsLinks?) -> Void, failure: @escaping (_ message: String) -> Void){
        do {
    ...
    static func getEnrollment(data: Data, success: @escaping (_ url: String,_ defaultCallToAction: String) -> Void, failure: @escaping (_ message: String) -> Void){
        do {
            if let json = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions.allowFragments) as? NSDictionary{
    ...
    static func getDashboard(data: Data,
    ...
    static func getReferrerByName(data: Data, success: @escaping (_ referrer: MentionmeReferrer?, _ foundMultipleReferrers: Bool?, _ links: [MentionmeContentCollectionLink]?) -> Void, failure: @escaping (_ message: String) -> Void){
        do{
            if let json = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions.allowFragments) as? NSDictionary{
    ...
    static func getRefereeRegister(data: Data, success: @escaping (_ offer: MentionmeOffer?, _ refereeReward: MentionmeRefereeReward?, _ contentCollectionLink: MentionmeContentCollectionLink?, _ status: String?) -> Void, failure: @escaping (_ message: String) -> Void){
        do{
            if let json = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions.allowFragments) as? NSDictionary{
                ...
                if let contentCollectionLinkDict = json["content"] as? NSDictionary{
                    contentCollectionLink = MentionmeContentCollectionLink(withDictionary: contentCollectionLinkDict)
                }
