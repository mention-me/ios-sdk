...
extension PKCS5 {
  ...
  public struct PBKDF2 {
    ...
    public init(
      password: [UInt8], salt: [UInt8], iterations: Int = 4096 /* c */,
      keyLength: Int? = nil /* dkLen */, variant: HMAC.Variant = .sha256
    ) throws {
...
extension PKCS5.PBKDF2 {
  fileprivate func ARR(_ i: Int) -> [UInt8] {
  ...
  // U_1 = PRF (P, S || INT (i))
  fileprivate func calculateBlock(_ salt: [UInt8], blockNum: Int) throws -> [UInt8]? {
