...
public final class AEADChaCha20Poly1305: AEAD {
  ...
  public static func encrypt(
    _ plainText: [UInt8], key: [UInt8], iv: [UInt8], authenticationHeader: [UInt8]
  ) throws -> (cipherText: [UInt8], authenticationTag: [UInt8]) {
    ...
    let tag = try calculateAuthenticationTag(
      authenticator: Poly1305(key: polykey), cipherText: cipherText,
  ...
  public static func decrypt(
    _ cipherText: [UInt8], key: [UInt8], iv: [UInt8], authenticationHeader: [UInt8],
    authenticationTag: [UInt8]
  ) throws -> (plainText: [UInt8], success: Bool) {
