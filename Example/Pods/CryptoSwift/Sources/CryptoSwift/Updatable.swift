...
public protocol Updatable {
  ...
  mutating func update(
    withBytes bytes: ArraySlice<UInt8>, isLast: Bool, output: (_ bytes: [UInt8]) -> Void) throws
}

extension Updatable {
  public mutating func update(
    withBytes bytes: ArraySlice<UInt8>, isLast: Bool = false, output: (_ bytes: [UInt8]) -> Void
  ) throws {
  ...
  public mutating func update(withBytes bytes: ArraySlice<UInt8>, isLast: Bool = false) throws
    -> [UInt8]
  {
  ...
  public mutating func update(
    withBytes bytes: [UInt8], isLast: Bool = false, output: (_ bytes: [UInt8]) -> Void
  ) throws {
  ...
  public mutating func finish(
    withBytes bytes: ArraySlice<UInt8>, output: (_ bytes: [UInt8]) -> Void
  ) throws {
