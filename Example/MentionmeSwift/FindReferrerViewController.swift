...
class FindReferrerViewController: UIViewController{
    ...
    @objc func findAction(){
        ...
        let request = MentionmeReferrerByNameRequest(mentionmeReferrerNameParameters: referrerNameParameters)
        
        //Calling the API 4. Referrer By Name
        Mentionme.shared.findReferrerByName(mentionmeReferrerByNameRequest: request, situation: "app-referee-find-referrer-screen", success: { (referrer, multipleNamesFound, contentCollectionLinks) in
