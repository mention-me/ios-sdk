...
class DashboardViewController: UIViewController, MFMailComposeViewControllerDelegate {
  ...
  func configureUI() {
    ...
    self.tableView.register(
      UINib(nibName: "IntroductionTableViewCell", bundle: nil),
      forCellReuseIdentifier: "introductionCell")
    self.tableView.register(
      UINib(nibName: "StatsTableViewCell", bundle: nil), forCellReuseIdentifier: "statsCell")
    self.tableView.register(
      UINib(nibName: "SharePanelTableViewCell", bundle: nil),
      forCellReuseIdentifier: "sharePanelCell")
    self.tableView.register(
      UINib(nibName: "RewardTableViewCell", bundle: nil), forCellReuseIdentifier: "rewardCell")
  ...
  func getDashboard() {
    ...
    let request = MentionmeDashboardRequest(
      mentionmeDashboardParameters: MentionmeDashboardParameters(emailAddress: email))

    //Calling the API 3. Dashboard
    Mentionme.shared.getReferrerDashboard(
      mentionmeDashboardRequest: request, situation: "dashboard-screen",
      success: { (offer, shareLinks, termLinks, stats, rewards) in
  ...
  func shareViaEmailAction() {
    ...
    if MFMailComposeViewController.canSendMail() {
      ...
      let alert = UIAlertController(
        title: "Error", message: "You need to set email settings.",
...
extension DashboardViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
    ...
    let label = UILabel(
      frame: CGRect(x: 16, y: 0, width: UIScreen.main.bounds.size.width - 32, height: 40))
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    if indexPath.section == 0 {
      ...
      if indexPath.row == 0 {
        let cell =
          tableView.dequeueReusableCell(withIdentifier: "introductionCell", for: indexPath)
          as! IntroductionTableViewCell
        ...
        let cell =
          tableView.dequeueReusableCell(withIdentifier: "statsCell", for: indexPath)
        ...
        let cell =
          tableView.dequeueReusableCell(withIdentifier: "sharePanelCell", for: indexPath)
          as! SharePanelTableViewCell
      ...
      let cell =
        tableView.dequeueReusableCell(withIdentifier: "rewardCell", for: indexPath)
